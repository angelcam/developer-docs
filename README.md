# Angelcam OpenAPI Specification
[![Build Status](https://travis-ci.com/angelcam/developer-docs.svg?branch=master)](https://travis-ci.com/angelcam/developer-docs)
...
6. If you did everything correct, https://angelcam.github.io/developer-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://angelcam.github.io/developer-docs/
- SwaggerUI: https://angelcam.github.io/developer-docs/swagger-ui/
- Look full spec:
    + JSON https://angelcam.github.io/developer-docs/swagger.json
    + YAML https://angelcam.github.io/developer-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://angelcam.github.io/developer-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://angelcam.github.io/developer-docs/ with url from the message: `Server started <url>`
